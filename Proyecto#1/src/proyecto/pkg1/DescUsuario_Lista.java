 ...
 * @author Sthephan
 */
public class DescUsuario_Lista {
    ...
    public DescUsuario_Lista(String nombreSimbolico, Date fechaCreacion, String usuarioCreacion, Date fechaModificacion, String usuarioModificacion, int numRegistros, int registrosActivos, int registrosInactivos, int maxReorganizacion) {
